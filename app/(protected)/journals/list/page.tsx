            ...
            <PopoverContent className="w-auto p-0 bg-slate-800 border-slate-700" align="end">
              <CalendarComponent
                ...
                classNames={{
                  ...
                  cell: "relative p-0 text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-blue-100/20 [&:has([aria-selected].day-range-end)]:rounded-r-md [&:has([aria-selected].day-range-start)]:rounded-l-md first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md",
                  day: "h-7 w-7 p-0 font-normal aria-selected:opacity-100",
                  day_range_start: "day-range-start",
                  day_range_end: "day-range-end",
                  day_selected: "bg-blue-200/50 text-slate-50 hover:bg-blue-200/50 hover:text-slate-50 focus:bg-blue-200/50 focus:text-slate-50",
